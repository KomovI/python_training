...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.login(wd)
        self.create_contact(wd, Contact(firstname="Test", middlename="Testerovich", lastname="Testerov", nickname="QA",
    ...
    def create_contact(self, wd, contact):
        ...
        Select(wd.find_element_by_name("bday")).select_by_visible_text(contact.birthdayDay)
        wd.find_element_by_xpath("//option[@value='" + contact.birthdayDay + "']").click()
        wd.find_element_by_name("bmonth").click()
        Select(wd.find_element_by_name("bmonth")).select_by_visible_text(contact.birthdayMonth)
        ...
        wd.find_element_by_name("phone2").send_keys(contact.secondaryHome)
